...
class Graph:
    ...
    def dfsByName(self, source_node, destination_node):
    ...
    def dfsById(self, source_node, destination_node):
        def dfsHelper(current_node, destination_node,
                      visited_set, path_lst):
            current_path = path_lst.copy()
            visited_set.add(current_node)
        ...
        path_lst = []
        visited_set = set()
        source_node = Station.objects.get(station_id=source_node)
        destination_node = Station.objects.get(station_id=destination_node)
        dfsHelper(source_node.station_name,
                  destination_node.station_name,  visited_set, path_lst)
        return self.path
